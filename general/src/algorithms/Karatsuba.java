...
public class Karatsuba {
    public static void main(String[] args) {
        ...
        System.out.printf("Result is %d", karatsuba(nr1,nr2));
    }
    ...
    private static BigInteger karatsuba(BigInteger number1, BigInteger number2) {
        ...
        if(length == 1) {
            ...
            BigInteger b = new BigInteger(number1.toString().substring(half));

            BigInteger c = new BigInteger(number2.toString().substring(0,half));
            BigInteger d = new BigInteger(number2.toString().substring(half));
            ...
            return new BigInteger(String.valueOf((int)Math.pow(10, half*2)))
                    .multiply(ac)
