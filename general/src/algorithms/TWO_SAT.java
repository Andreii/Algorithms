...
public class TWO_SAT {
    ...
    public static void main(String[] args) throws Exception {
        Scanner scanner = new Scanner(new File("general/resources/2sat1.txt"));
//        Scanner scanner = new Scanner(new File("general/resources/2sat_small.txt")); 1
//        Scanner scanner = new Scanner(new File("general/resources/2sat_small2.txt")); 0
