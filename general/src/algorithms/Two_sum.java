...
public class Two_sum {
    ...
    private static final int RANGE_LEFT = 10;
    private static final int RANGE_RIGHT = 40;
...
//        Scanner in = new Scanner(new File("/home/act/mds/projects/git/algo/general/src/algorithms/2sum.txt"));
        Scanner in = new Scanner(new File("/Users/andrei/IdeaProjects/algo/general/src/algorithms/2sum_test2.txt"));
        // 2sum_test -> 3,10 -> 8
        // 2sum_test2 -> 10,40 -> 11
        // 2sum_test3 -> 1,10 -> 2
        // 2sum_test4 -> 30,40 -> 0
